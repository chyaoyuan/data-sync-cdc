...
if __name__ == '__main__':
    # with open("/Volumes/Expansion/CGL202310/gllue_maybe_exist_id_20231012.json") as f:
    ...
    async def execute():
        async with aiohttp.ClientSession() as session:
            ...
            id_list = [str(i) for i in range(2530560,2560560)]
            ...
            for candidate_task in asyncio.as_completed(task_list):
                ...
                for entity in entity_list:
                    logger.info(entity)
                    with open("candidate.jsonl", "a") as f:
