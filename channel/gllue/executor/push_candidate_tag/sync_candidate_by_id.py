...
import json
import traceback
from channel.gllue.executor.push_candidate_tag.resume import ResumeSDKApplication
...
async def execute(tip_tag_app, gle_entity_id, entity, tip_app, schema_app, candidate_push_app, tip_config,candidate_pull_app):
    ...
    resume_sdk_candidate = await ResumeSDKApplication().parse(latest_resume_info["fileName"],
