...
with open(f"/Users/chenjiabin/Project/data-sync-cdc/channel/linkedin/project_id_1", "w") as f2:
    f2.write(json.dumps(need_run_project_list[0:count], ensure_ascii=False))
with open(f"/Users/chenjiabin/Project/data-sync-cdc/channel/linkedin/project_id_2", "w") as f2:
    f2.write(json.dumps(need_run_project_list[count+1:count*2], ensure_ascii=False))
with open(f"/Users/chenjiabin/Project/data-sync-cdc/channel/linkedin/project_id_3", "w") as f2:
    f2.write(json.dumps(need_run_project_list[count*2+1:count*3], ensure_ascii=False))
with open(f"/Users/chenjiabin/Project/data-sync-cdc/channel/linkedin/project_id_4", "w") as f2:
